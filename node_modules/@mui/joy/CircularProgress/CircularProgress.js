...
const CircularProgressRoot = styled('span', {
  ...
  return _extends({
    ...
    '--_track-thickness': getThickness('track', '10px'),
    '--_progress-thickness': getThickness('progress', '10px'),
    '--_root-size': 'var(--CircularProgress-size, 80px)'
    // NEWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW //
  }, ownerState.instanceSize === 'xl' && {
    ...
    alignItems: 'center',
    flexShrink: 0,
    // NEW EDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD //
...
process.env.NODE_ENV !== "production" ? CircularProgress.propTypes /* remove-proptypes */ = {
   ...
   * @default 'md'
   */
  size: PropTypes /* @typescript-to-proptypes-ignore */.oneOfType([PropTypes.oneOf(['sm', 'md', 'lg', 'xl']), PropTypes.string]),
  /**
